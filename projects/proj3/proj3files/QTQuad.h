...
class QTQuad {
 ...
 private:
  ...
  // Helper Function
  // Returns correct quadrant based on coordinate points
  int wantedQuad(const Point &pt, const BBox &bounds);

  // Helper Function
  // Deletes empty quadrants to keep tree compact as possible
  void pruneTree(int quadrant);
